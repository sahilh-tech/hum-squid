...
class ModbusMaster
{
  public:
    ...
    void preTransmission(std::function<void()> preTransmission);
    void postTransmission(std::function<void()> postTransmission);
  ...
  private:
    ...
    std::function<void()> _preTransmission;
    std::function<void()> _postTransmission;   
};
#endif
