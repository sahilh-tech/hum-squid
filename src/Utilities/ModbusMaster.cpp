...
// }
void ModbusMaster::preTransmission(std::function<void()> preTransmission)
{
  _preTransmission = preTransmission;
}
...
// }
void ModbusMaster::postTransmission(std::function<void()> postTransmission)
{
  _postTransmission = postTransmission;
}
...
{
  Serial.println(" inside ModbusMasterTransaction");
